...
const approveDepositRepayERC20 = async(web3, connectedAddress, networkType, market) => {
    ...
    let response = await contract.methods.approve(Config.DepositRepayContract, maxApproval.toString(10)).send({from: connectedAddress})
...
const approveDepositSwapERC20 = async(web3, connectedAddress, networkType, market) => {
    ...
    let response = await contract.methods.approve(Config.DepositSwapContract, maxApproval.toString(10)).send({from: connectedAddress})
...
export default {
    ...
    approveDepositRepayERC20: approveDepositRepayERC20,
